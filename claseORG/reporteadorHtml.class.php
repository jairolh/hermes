...
function mostrarReporte($configuracion,$registro,$nombre,$titulo,$enlace)
	{    //var_dump($_REQUEST);
                                                                                        ...
                                                                                        {//inicia llenado de la barra
                                                                                         ...
                                                                                         ?><tr><?
                                                                                                foreach($cabecera as $cab=>$value)
                                                                                                    { 
                                                                                                         //genera los enlaces
                                                                                                        if(is_array($enlace) && $enlace['pagina']!='' && $enlace['campo_enlace']==$cab)
                                                                                                                { $variable="pagina=".$enlace['pagina'];
                                                                                                                    foreach ($enlace as $enl => $valor_enl) {

                                                                                                                       if($valor_enl=='$D{\'' . $enl . '\'}' && $enl!='pagina' && $enl!='campo_enlace' )
                                                                                                                                      { $variable.="&".$enl."=".$registro[$key][$enl];}
                                                                                                                       elseif($valor_enl=='$R{\'' . $enl . '\'}' && $enl!='pagina' && $enl!='campo_enlace' )
                                                                                                                                      { $variable.="&".$enl."=".$_REQUEST[$enl];}               
                                                                                                                       elseif($enl!='pagina' && $enl!='campo_enlace' )               
                                                                                                                                      { $variable.="&".$enl."=".$enlace[$enl];}
                                                                                                      ...
                                                                                                      ?><td class='texto_elegante estilo_td' ><?
                                                                                                        ...
                                                                                                        if($variable!='')
                                                                                                             {echo "<a href=".$indice . $variable.">&nbsp;".$dato."&nbsp;</a>"; }
                                                                                                        else {echo "&nbsp;".$dato."&nbsp;";}
                                                                                                        ?></td><?
                                                                                                    } 
                                                                                        ?></tr><?
