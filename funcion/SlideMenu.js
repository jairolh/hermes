  ...
  self.status=lnk
	...
	if(type=="top"){
		...
		if(text=="seperator"){
			...
			menus[a].seperator=1
    		  	...
    		  	str+='\t<div id="divSlide'+a+'" class="clSlide"><a href="'+lnk+'" '+tg+' onmouseover="swmenu('+a+',-1,-1); if(bw.ie || bw.ns6) this.blur(); '
    		  	if(lnk=="#") str+='return false'
     			str+='" class="clSlideLinks" onMouseOver="link();return true;" onClick="link();return true;"> '+text+'</a><br></div>\n'
		}
	...
	if(type=="salir"){
		menus[a]=new Array();
    		  	...
    		  	str+='\t<div id="divSlide'+a+'" class="clSlide" style="background:blue; !important"><a href="'+lnk+'" '+tg+'  '
    		  	if(lnk=="#") str+='return false'
     			str+='" class="clSlideLinks" onMouseOver="link();return true;" onClick="link();return true;"> '+text+'</a><br></div>\n'
    ...
    if(lnk=="#") str+='return false'
    str+='" href="'+lnk+'" class="clSlideSubLinks" onMouseOver="link();return true;" onClick="link();return true;">  '+text+'</a><br></div>\n'
		b++; menus[a-1].subs=b; menus[a-1][b-1]=new Array(); c=0; menus[a-1][b-1].subs=0
	}else if(type=="sub2"){
		str+='\t\t<div id="divSlideSub'+(a-1)+'_'+(b-1)+'_'+c+'" class="clSlideSub2"><a '+tg+' href="'+lnk+'" class="clSlideSub2Links" onMouseOver="link();return true;" onClick="link();return true;">  '+text+'</a><br></div>\n'
		c++; menus[a-1][b-1].subs=c; menus[a-1][b-1][c-1]=new Array(); d=0; menus[a-1][b-1][c-1].subs=0
	}
	
	if(end){
//	 str+='<div  style="cursor:pointer; width:100%; height:5%; background:blue; top:95%">Salir</div>'
	 str+="</div>"
	 }
	document.write(str)
}
function preLoadBackgrounds(){
  ...
  return this
		...
		pxspeed=20 //Velocidad de animacion del menu
		timspeed=40 //Timer Velocidad de animacin
		menuy=230 //Margen superior
		menux=120 //Margen izquierda del menu

		
		//Images del menu
		level0_regular="http://localhost/bodega_datos/grafico/level0_regular.png"
		level0_round="http://localhost/bodega_datos/grafico/level0_round.png"
		level1_regular="http://localhost/bodega_datos/grafico/level1_regular.png"
		level1_round="http://localhost/bodega_datos/grafico/level1_round.png"	
		level1_sub="http://localhost/bodega_datos/grafico/level1_sub.png"
		level1_sub_round="http://localhost/bodega_datos/grafico/level1_sub_round.png"
		level1_round2="http://localhost/bodega_datos/grafico/level1_round2.png"
		level2_regular="http://localhost/bodega_datos/grafico/level2_regular.png"
		level2_round="http://localhost/bodega_datos/grafico/level2_round.png"
