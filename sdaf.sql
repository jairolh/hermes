...
CREATE DATABASE sdaf DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci ;

GRANT ALL PRIVILEGES ON sdaf.*
TO 'sdaf'@'localhost'
IDENTIFIED BY 'admin_sdaf'
WITH GRANT OPTION;
...
--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_area`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_area`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_area` (
...
--
-- Volcado de datos para la tabla `sdaf`.`sdaf_area`
--

INSERT INTO `sdaf`.`sdaf_area` (`id_area`, `id_dependencia`, `nombre`, `descripcion`, `estado`) VALUES
...
--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_area_ttramite`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_area_ttramite`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_area_ttramite` (
...
--
-- Volcado de datos para la tabla `sdaf`.`sdaf_area_ttramite`
--

INSERT INTO `sdaf`.`sdaf_area_ttramite` (`id_area`, `id_Ttramite`, `fecha_registro`, `fecha_fin`, `estado`, `descripcion`, `posicion_tramite`) VALUES
...
--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_bloque`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_bloque`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_bloque` (
...
--
-- Volcado de datos para la tabla `sdaf`.`sdaf_bloque`
--

INSERT INTO `sdaf`.`sdaf_bloque` (`id_bloque`, `nombre`, `descripcion`, `grupo`) VALUES
...
--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_bloque_pagina`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_bloque_pagina`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_bloque_pagina` (
...
--
-- Volcado de datos para la tabla `sdaf`.`sdaf_bloque_pagina`
--

INSERT INTO `sdaf`.`sdaf_bloque_pagina` (`id_pagina`, `id_bloque`, `seccion`, `posicion`) VALUES
(1, 1, 'C', 1),
(1, 3, 'B', 1),
(2, 4, 'C', 1),
(1, 6, 'A', 1),
...
--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_configuracion`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_configuracion`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_configuracion` (
...
--
-- Volcado de datos para la tabla `sdaf`.`sdaf_configuracion`
--

INSERT INTO `sdaf`.`sdaf_configuracion` (`id_parametro`, `parametro`, `valor`) VALUES
(1, 'titulo', 'SDAF - Area Financiera Universidad Distrital Francisco José de Caldas'),
(2, 'raiz_documento', '/usr/local/apache/htdocs/sdaf'),
...
--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_dbms`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_dbms`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_dbms` (
...
--
-- Volcado de datos para la tabla `sdaf`.`sdaf_dbms`
--

INSERT INTO `sdaf`.`sdaf_dbms` (`nombre`, `dbms`, `servidor`, `puerto`, `ssl`, `db`, `usuario`, `password`) VALUES
('localxe', 'oci8', 'localhost', 1521, '', 'XE', 'system', 'system');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_dependencia`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_dependencia`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_dependencia` (
...
--
-- Volcado de datos para la tabla `sdaf`.`sdaf_dependencia`
--

INSERT INTO `sdaf`.`sdaf_dependencia` (`id_dependencia`, `nombre`, `descripcion`, `estado`) VALUES
...
--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_estado`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_estado`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_estado` (
...
--
-- Volcado de datos para la tabla `sdaf`.`sdaf_estado`
--

INSERT INTO `sdaf`.`sdaf_estado` (`id_estado`, `nombre`, `tipo`) VALUES
('0', 'INACTIVO', 'U'),
('1', 'ACTIVO', 'U'),
('2', 'PARA TRAMITE', 'A'),
('3', 'EN TRAMITE', 'A'),
...
--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_estilo`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_estilo`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_estilo` (
...
--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_logger`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_logger`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_logger` (
...
--
-- Volcado de datos para la tabla `sdaf`.`sdaf_logger`
--
...
--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_log_usuario`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_log_usuario`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_log_usuario` (
...
--
-- Volcado de datos para la tabla `sdaf`.`sdaf_log_usuario`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_noticia`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_noticia`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_noticia` (
...
--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_pagina`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_pagina`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_pagina` (
...
--
-- Volcado de datos para la tabla `sdaf`.`sdaf_pagina`
--

INSERT INTO `sdaf`.`sdaf_pagina` (`id_pagina`, `nombre`, `descripcion`, `modulo`, `nivel`, `parametro`) VALUES
...
--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_registrado`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_registrado`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_registrado` (
...
--
-- Volcado de datos para la tabla `sdaf`.`sdaf_registrado`
--

INSERT INTO `sdaf`.`sdaf_registrado` (`id_usuario`, `identificacion`, `nombre`, `apellido`, `correo`, `telefono1`, `extensiones1`, `usuario`, `clave`, `celular`, `fecha_registro`, `estado`) VALUES
...
--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_registrado_borrador`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_registrado_borrador`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_registrado_borrador` (
...
--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_registrado_subsistema`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_registrado_subsistema`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_registrado_subsistema` (
...
--
-- Volcado de datos para la tabla `sdaf`.`sdaf_registrado_subsistema`
--

INSERT INTO `sdaf`.`sdaf_registrado_subsistema` (`id_usuario`, `id_subsistema`, `estado`, `id_area`, `fecha_registro`, `fecha_fin`) VALUES
(1, 1, 1, 0, '2011-07-25', '2020-12-31');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_subsistema`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_subsistema`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_subsistema` (
...
--
-- Volcado de datos para la tabla `sdaf`.`sdaf_subsistema`
--

INSERT INTO `sdaf`.`sdaf_subsistema` (`id_subsistema`, `nombre`, `etiqueta`, `id_pagina`, `observacion`) VALUES
...
--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_tconcep_ttramite`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_tconcep_ttramite`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_tconcep_ttramite` (
  `id_Ttramite` int(7) NOT NULL,
...
--
-- Volcado de datos para la tabla `sdaf`.`sdaf_tconcep_ttramite`
--

INSERT INTO `sdaf`.`sdaf_tconcep_ttramite` (`id_Ttramite`, `id_tconcep`, `fecha_registro`, `fecha_fin`, `estado`) VALUES
...
--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_tipo_concepto`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_tipo_concepto`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_tipo_concepto` (
  `id_tconcep` int(7) NOT NULL,
  `nombre` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `descripcion` text COLLATE utf8_spanish_ci,
...
--
-- Volcado de datos para la tabla `sdaf`.`sdaf_tipo_concepto`
--

INSERT INTO `sdaf`.`sdaf_tipo_concepto` (`id_tconcep`, `nombre`, `descripcion`, `estado`) VALUES
...
--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_tipo_tramite`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_tipo_tramite`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_tipo_tramite` (
  `id_Ttramite` int(7) NOT NULL,
  `nombre` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `descripcion` text COLLATE utf8_spanish_ci,
  `estado` varchar(1) COLLATE utf8_spanish_ci NOT NULL,
...
--
-- Volcado de datos para la tabla `sdaf`.`sdaf_tipo_tramite`
--

INSERT INTO `sdaf`.`sdaf_tipo_tramite` (`id_Ttramite`, `nombre`, `descripcion`, `estado`, `fecha_registro`, `resumen`, `id_dependencia`, `dias_respuesta`) VALUES
...
--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_tmp_asigna`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_tmp_asigna`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_tmp_asigna` (
...
--
-- Volcado de datos para la tabla `sdaf`.`sdaf_tmp_asigna`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_tramita_solicitud`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_tramita_solicitud`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_tramita_solicitud` (
  `id_sol` int(11) NOT NULL DEFAULT '0',
  `id_area` int(7) NOT NULL DEFAULT '0',
  `id_usuario` int(7) NOT NULL DEFAULT '0',
  `estado` varchar(1) COLLATE utf8_spanish_ci NOT NULL DEFAULT '1',
...
--
-- Volcado de datos para la tabla `sdaf`.`sdaf_tramita_solicitud`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_tSolicitud`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_tSolicitud`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_tSolicitud` (
...
--
-- Volcado de datos para la tabla `sdaf`.`sdaf_tSolicitud`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_valor_sesion`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_valor_sesion`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_valor_sesion` (
...
--
-- Estructura de tabla para la tabla `sdaf`.`sdaf_variable`
--

DROP TABLE IF EXISTS `sdaf`.`sdaf_variable`;
CREATE TABLE IF NOT EXISTS `sdaf`.`sdaf_variable` (
...
--
-- Volcado de datos para la tabla `sdaf`.`sdaf_variable`
--

INSERT INTO `sdaf`.`sdaf_variable` (`id_tipo`, `valor`, `descripcion`, `tipo`) VALUES
