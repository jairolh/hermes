...
define('SW_PROJECT_PASSWORD', 'reporteshermes2014');
...
define('SW_PROJECT_TITLE', 'Reportes Hermes');
...
define('SW_DB_USER', 'hermes');
define('SW_DB_PASSWORD', 'admin_hermes');
define('SW_DB_HOST', '127.0.0.1');
define('SW_DB_DATABASE', 'hermes');
}
