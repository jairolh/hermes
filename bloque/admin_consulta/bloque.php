...
//Clase
class bloqueAdminConsulta extends bloque
{

	 public function __construct($configuracion)
	{
 		$this->sql = new sql_adminConsulta();
 		$this->funcion = new funciones_adminConsulta($configuracion, $this->sql);
...
$esteBloque = new bloqueAdminConsulta($configuracion);
