		...
		{ 
			...
			case "editar":
				...
				break;
                        ...
                        case 'nuevoRol':
		  		//Consultar usuario
				$this->funcion->nuevoRol($configuracion,$_REQUEST["cod_usuario"],$_REQUEST["cod_area"]);
				break;       
                            
                        case 'editarRol':
		  		//Consultar usuario
                                $busquedaRol = array( criterio_busqueda => "COD_US", 
			...
			case "cambiar_clave":
				...
				$this->funcion->editarRegistro($configuracion,$tema,$_REQUEST["cod_usuario"], $this->acceso_db, "");
				break;
