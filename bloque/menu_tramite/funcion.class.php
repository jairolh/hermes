...
class registro_menutramite implements funcionRegistro
{
		...
		<tr>
			<td >
				<table align="center" border="0" cellpadding="5" cellspacing="2" class="bloquelateral_2" width="100%">
					<tr class="bloquelateralcuerpo">
						<td class="cuadro_simple">
						<form enctype='multipart/form-data,text/plain' method='POST' action='index.php' name='adminTramite'>
						<table width="100%" border="1">
						<tr class="texto_subtitulo">
							<td class="cuadro_simple">Buscar Solicitud de Tramite:
