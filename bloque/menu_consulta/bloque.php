...
* @link		N/D
* @description  Menu principal del bloque consulta 
* @usage        
*****************************************************************************/
...
//Clase 
class bloqueMenuConsulta extends bloque
{
	//@Método constructor donde se crea un objeto funcion de la clase registro_menuusuario 
	 public function __construct($configuracion)
	{
		$this->funcion=new registro_menuConsulta($configuracion);
...
$esteBloque=new bloqueMenuConsulta($configuracion);
